        ...
        <div class="card-body">
            <form action="{{ route('tujuanPenawarans.update', $tujuanPenawaran->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pengajuan" name="pengajuan" value="{{ old('pengajuan', $tujuanPenawaran->pengajuan) }}" required>
                </div>
                <div class="form-group">
                    <label for="tujuan">Tujuan</label>
                    <input type="text" class="form-control" id="tujuan" name="tujuan" value="{{ old('tujuan', $tujuanPenawaran->tujuan) }}" required>
                </div>

                    ...
                    <div class="card-body">
                        <form action="{{ route('projectKwitansis.update', $projectKwitansi->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <label for="project_pembelian_id" class="form-label">Purchase Order:</label>
                                <select class="form-select" id="project_pembelian_id" name="project_pembelian_id_disabled"
                                    disabled>
                                ...
                                <input type="hidden" name="project_pembelian_id"
                                    value="{{ old('project_pembelian_id', $projectKwitansi->project_pembelian_id) }}">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="kepada_yth" name="kepada_yth"
                                    value="{{ old('kepada_yth', $projectKwitansi->kepada_yth) }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="kendaraan" name="kendaraan"
                                    value="{{ old('kendaraan', $projectKwitansi->kendaraan) }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="nomor_polisi" name="nomor_polisi"
                                    value="{{ old('nomor_polisi', $projectKwitansi->nomor_polisi) }}"

                    ...
                    <div class="card-body">
                        <form action="{{ route('projectKwitansis.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <label for="search_project_pembelian">Search Purchase Order:</label>
                                <input type="text" class="form-control mb-2" id="search_project_pembelian"
                                    placeholder="Search..." onkeyup="filterOptions()">
                                ...
                                <select class="form-control" id="project_pembelian_id" name="project_pembelian_id" required>
                                    ...
                                    @foreach ($projectPembelians as $projectPembelian)
                                        <option value="{{ $projectPembelian->id }}"
                                            ...
                                            {{ $projectPembelian->po_ditunjukan_kepada }} - {{ $projectPembelian->project }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <script>
                                function filterOptions() {
                                    const input = document.getElementById('search_project_pembelian');
                                    const filter = input.value.toLowerCase();
                                    const select = document.getElementById('project_pembelian_id');
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="kepada_yth" name="kepada_yth"
                                    value="{{ old('kepada_yth') }}" placeholder="Enter recipient's name">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="proyek" name="proyek"
                                    value="{{ old('proyek') }}" placeholder="Enter project name">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="lokasi" name="lokasi"
                                    value="{{ old('lokasi') }}" placeholder="Enter location">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="kendaraan" name="kendaraan"
                                    value="{{ old('kendaraan') }}" placeholder="Enter vehicle details">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="nomor_polisi" name="nomor_polisi"
                                    value="{{ old('nomor_polisi') }}" placeholder="Enter license plate number">
                            </div>

                            <!-- Tanggal Surat Jalan Field -->
                            <div class="form-group mb-3">
                                <label for="tanggal_surat_jalan">Tanggal Surat Jalan:</label>
                                <input type="date" class="form-control" id="tanggal_surat_jalan"
                                    name="tanggal_surat_jalan" value="{{ old('tanggal_surat_jalan') }}">
                            </div>

                            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Simpan</button>
                            <a href="{{ route('projectKwitansis.index') }}" class="btn btn-secondary"><i

        ...
        <form action="{{ route('batchPekerjaanKwitansi.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                @if ($selectedPekerjaanKwitansiId)
                    ...
                    <input type="hidden" name="pekerjaan_kwitansi_id" value="{{ $selectedPekerjaanKwitansiId }}">
                @else

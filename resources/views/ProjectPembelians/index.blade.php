        ...
        <tbody>
            @foreach($projectPembelians as $projectPembelian)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('projectPembelians.show', $projectPembelian->id) }}" class="btn btn-info">Show</a>
                        <a href="{{ route('projectPembelians.edit', $projectPembelian->id) }}" class="btn btn-warning">Edit</a>
